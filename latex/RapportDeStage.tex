...
\usepackage{graphicx,hyperref,float,comment,listings,amsmath,longtable,geometry,caption,ragged2e,svg,listingsutf8,subcaption}
...
\begin{itemize}
	\item On envoie une instruction au programme
	\item Quand on détecte que le buffer de sortie n'est pas vide on s'arrête
\end{itemize}
